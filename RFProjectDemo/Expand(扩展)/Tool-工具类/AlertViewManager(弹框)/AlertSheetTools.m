...
@implementation AlertSheetTools

+ (void)alertTitle:(NSString *)title message:(NSString *)msg {
    [self AlertSheetTitle:title message:msg arrTitleAction:nil style:UIAlertControllerStyleAlert superVC:[UIViewController currentViewController] blockClick:nil];
}
