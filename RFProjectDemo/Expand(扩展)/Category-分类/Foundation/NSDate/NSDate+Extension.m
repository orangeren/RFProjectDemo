...
+ (NSDate *)dateWithTimeStamp:(long long)timeStamp{
    long long newTimeStamp = timeStamp / 1000;
...
#pragma mark - 通过时间戳转化到字符串
/** 时间戳转化成字符串 */
+ (NSString *)dateStringFromLongDate:(long long)dateLong{
...
+ (NSString *)dateMMStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
/** 转化成yyyy-mm-dd hh:mm格式字符串 */
+ (NSString *)dateYMDHMStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"YYYY-MM-dd HH:mm"];
...
+ (NSString *)dateddStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
/** 转化成mm/dd */
+ (NSString *)dateMDtringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
/** 显示yyyy-mm-dd这样格式的字符创 */
+ (NSString *)dateYMDacrossStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"YYYY-MM-dd"];
...
/** 2019年4月5日 */
+ (NSString *)dateChineseYMDStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"YYYYY年MM月dd日"];
    NSString *dateString = [formatter stringFromDate:dateTime];
    return dateString;
}
/** 4月5日 */
+ (NSString *)dateChineseMDStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
/** 时间戳转化成月日 - 时分字符串 */
+ (NSString *)dateMDHMStringFromLongDate:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
...
/** 转化成显示月日上午下午的时间字符串 */
+ (NSString *)dateMDMAStringFromLongDate:(long long)dateLong
{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    NSDateFormatter *date_formatter = [[NSDateFormatter alloc] init];
    [date_formatter setDateFormat:@"MM-dd aa"];
    NSString *the_date_str = [date_formatter stringFromDate:dateTime];
    return the_date_str;
}

/** 将时间戳转化成NSDate */
+ (NSDate *)dateFromLonglongStampTime:(long long)dateLong{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    return dateTime;
}
...
+ (NSInteger)intervalSinceNow: (long long)dateLong
{
    long long date = (long long)dateLong / 1000;
    NSDate* dat = [NSDate dateWithTimeIntervalSinceNow:0];
    NSTimeInterval now=[dat timeIntervalSince1970]*1;
    NSTimeInterval cha=date-now;
    return cha;
}

/** 时间戳转化成NSDateComponents */
+ (NSDateComponents *)dateComponentsFromDate:(long)dateLong
{
    long long date = (long long)dateLong / 1000;
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:date];
    //    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    ...
    NSDateComponents *dateComponent = [calendar components:unitFlags fromDate:dateTime];
    return dateComponent;
}


/** 时间字符串(YYYY/MM/dd HH:mm)转化成时间戳 */
+ (long long)timeStampFromDateStr:(NSString *)dateStr{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"YYYY/MM/dd HH:mm"];
...
+ (long long)timeStampFromDateStr:(NSString *)dateStr dataFormat:(NSString *)dataFormat {
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
